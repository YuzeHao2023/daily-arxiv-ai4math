# AI4math ArXiv Daily - Usage Instructions

## Overview

AI4math ArXiv Daily automatically fetches the latest papers from arXiv related to AI for mathmatics (AI4math) topics and organizes them by category.
