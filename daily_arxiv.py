...
def json_to_md(filename,md_filename,
    ...
    with open(md_filename,"a+") as f:
        ...
        if use_title == True:
            ...
            #         "</ins><br>Automatically Update ai4math Papers Daily</h1></p>\n"))
